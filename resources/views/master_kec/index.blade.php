    ...
    <div class="container" id="app_vue">
      <div class="card">
        <div class="body">
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    <a href="{{ url('master_kec/create') }}" class="btn btn-info">Tambah Data</a>
                </div>
            </div>

            <div class="row mb-2">
                <div class="col-lg-3">
                    <select class="form-control" v-model="filter.kode_kab" @change="setDatas(url_name)">
...
var vm = new Vue({  
    ...
    methods: {
        urlEdit: function(dataId){
            return {!! json_encode(url('/master_kec')) !!} + `/${dataId}/edit`
        },
